...
mod tests {
    ...
    fn working_label_pulses_dots_through_full_cycle() {
        ...
        assert_eq!(
            super::footer_working_label(0, Locale::En),
            format!("{} working", w(0))
        );
        assert_eq!(
            super::footer_working_label(1, Locale::En),
            format!("{} working", w(1))
        );
        assert_eq!(
            super::footer_working_label(2, Locale::En),
            format!("{} working.", w(2))
        );
        assert_eq!(
            super::footer_working_label(3, Locale::En),
            format!("{} working.", w(3))
        );
        assert_eq!(
            super::footer_working_label(8, Locale::En),
            format!("{} working", w(8)),
